...
$requirements = array(
    ...
    array(
        ...
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii-caching-memcache.web">MemCache</a>',
        'memo' => extension_loaded('memcached') ? 'To use memcached set <a href="http://www.yiiframework.com/doc-2.0/yii-caching-memcache.web#$useMemcached-detail">MemCache::useMemcached</a> to <code>true</code>.' : ''
    ),
    // CAPTCHA:
    array(
        ...
        'mandatory' => false,
        'condition' => $gdOK,
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii-captcha-captcha.web">Captcha</a>',
        'memo' => $gdMemo,
    ),
    array(
...
if (!version_compare(phpversion(), '5.5', '>=')) {
    $requirements[] = array(
        ...
        'by' => '<a href="http://www.yiiframework.com/doc-2.0/yii-caching-apccache.web">ApcCache</a>',
    );
}
